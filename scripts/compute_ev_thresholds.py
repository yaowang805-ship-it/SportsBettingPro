...
# 样本纪律(业界标准: CLV 200 注才稳定, 早期 CLV 是噪声 —— 80注+5% 到 340注 会掉到 +1.8%;
# 2026-09-02 职业团队对标: 200 注前 CLV 不稳定, 500-1000 注才能判断策略, ROI 要 1000-3000 注才收敛)
#   n >= 200  → "确认",   中位 CLV > 2%          且 正率≥55%
#   30<=n<200 → "方向性", 中位 CLV > 2%+1%(shrink) 且 正率≥55% —— 小样本要更严
