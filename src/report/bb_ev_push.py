...
# ===================================================================
# 市场质量权重 — 130,310场真实历史数据驱动 (2026-07-25 重校准)
# ===================================================================
# 数据源:
#   1. ⚽足球: Pinnacle 72,806场收盘赔率 (18联赛×13赛季, 283,368笔)
#      → 1X2抽水4.29%, OU抽水3.87%, Pinnacle近乎完美校准
#      → 德甲最有效(1.88%), 希超最差(7.41%)
#   2. 🏀NBA: 15赛季模型回测 (57,504场)
#      → 让分edge=2.2%, 胜负edge=1.8%, 大小分edge=0.9%
#   3. 🎾网球: FLB研究 (低赔方实际回报好39%)
#   4. ⚾棒球: 公开研究(OH > ML)

# --- 足球 (Pinnacle 72,806场收盘) ---
# 1X2抽水4.29% > OU抽水3.87% → OU公平价更可靠, 差异极小
MARKET_QUALITY_FOOTBALL = {
    "ou":   1.11,  # OU抽水最低(3.87%)→Pinnacle最自信
    "btts": 1.05,  # 学术研究支持, 接近OU效率
    "hc":   1.00,  # 让球: 标准
    "dnb":  1.00,  # 平局退款: 中性
    "dc":   0.95,  # 双重机会: 从1X2推导
    "1x2":  0.90,  # 抽水最高(4.29%)→略降
    "ht":   0.85,  # 上半场: 数据有限, 保守
    "corner": 0.80, # 角球: 无Pinnacle收盘数据
    "htft": 0.80,  # 半全场: 无数据
    "oe":   0.85,  # 单/双: 无数据
}
...
MARKET_QUALITY_BASKETBALL = {
    "hc":   1.34,  # 让分: 最强模型edge ¥22.4/场
    "1x2":  1.06,  # 胜负: 第二 ¥17.7/场
    "ou":   0.60,  # 大小分: 第三 ¥9.0/场
}
