...
# 2026-07-24 全面回测调整，详见 reports/回测分析与优化方案_20260724.md
MARKET_QUALITY = {
    # 权重基于135笔结算数据回测 + 130,000+公开研究数据：
    # >1.0 = 该市场历史表现显著优于基准，提高排序优先级
    # <1.0 = 该市场历史表现差，需要更高EV才能获得同等优先级
    "ou":   1.20,  # 大小球: 7笔 +26.6% ROI + 10笔 +10% ROI → 最可靠信号，大幅提高
    "btts": 1.15,  # 双边进球: 6笔 +20.3% ROI + 5笔 +3.1% ROI → 稳定盈利，提高
    "hc":   1.00,  # 让球: 样本偏小，保持基准
    "dnb":  0.90,  # 平局退款: 无结算数据，从0.80上调(学术研究显示AH市场优于1X2)
    "dc":   0.80,  # 双重机会: 1笔 -100%，样本不足
    "oe":   0.80,  # 单/双: 新市场无数据
    "htft": 0.80,  # 半全场: 新市场无数据
    "corner": 0.70, # 角球: 新市场无数据，保守
    "ht":   0.70,  # 上半场: 5笔上半场客胜 -38.1% ROI，下调
    "1x2":  0.50,  # 独赢: 47笔全面亏损（home -47.1%, away -27.6%, draw -100%）
                   #         即使去掉世界杯36笔仍-4%，大幅下调
}
