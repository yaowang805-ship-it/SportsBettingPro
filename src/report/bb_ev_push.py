...
# ===================================================================
# 市场质量权重 — 按运动区分，基于真实海量数据
# ===================================================================
# 数据源:
#   1. NBA 15赛季回测 (2012-2026, 57,504场): Spread ¥22.4/场 > ML ¥17.7/场 > OU ¥9.0/场
#   2. Pinnacle 足球收盘赔率 (61,404场, 255,534笔): 1X2抽水4.29%, OU抽水3.87%
#      → Pinnacle 近乎完美校准，市场间差异极小
#      → 权重基于抽水倒数: OU最可靠(3.87%), 1X2稍弱(4.29%)
#   3. 网球FLB研究: 低赔方比高赔方实际回报好39%
#   4. 棒球公开研究: 总得分 > 独赢

# --- 足球市场权重 (Pinnacle 61,404场收盘赔率数据驱动) ---
# 1X2抽水4.29% > OU抽水3.87% → OU公平价更可靠
MARKET_QUALITY_FOOTBALL = {
    "ou":   1.11,  # Pinnacle OU抽水最低(3.87%)→最可靠
    "btts": 1.05,  # BTTS: 样本不足但学术研究支持
    "hc":   1.00,  # 让球: 标准
    "dnb":  1.00,  # 平局退款: 中性
    "dc":   0.95,  # 双重机会: 从1X2推导
    "1x2":  0.90,  # Pinnacle 1X2抽水最高(4.29%)→略降
    "ht":   0.85,  # 上半场: 数据有限
