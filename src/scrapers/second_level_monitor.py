    ...
    def _handle_live_g04(self, match_id, data):
        ...
        for it in data.get("items", []):
            ...
            sig = {"match_id": match_id, "sub": sub, "desig": desig[d],
                   ...
                   "match": {"home": lv["home"], "away": lv["away"], "sport": lv.get("sport", ""), "league_cn": lv.get("league_name", "滚球")},
    ...
    def _try_live_auto_bet(self, sig):
        ...
        if code == 0:
            ...
            self._notify_bet(
                ...
                f"{_sport_cn} | 滚球 | {_league} | {sig['desig']} | BB {sig['bb_odds']:.2f} vs 公平价 {sig['fair']:.2f} | 溢价 {sig['ev']:+.2f}%\n"
