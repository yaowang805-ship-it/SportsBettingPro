...
MARKET_TYPES = {
    ...
    5: {  # 网球 (5001=独赢, 5002=让局Game Handicap, 5003=总局数, 5004=让盘Set Handicap, 5012=盘胜者)
        "ml": 5001, "hc": 5002, "ou": 5003,
        "ht_ml": 5012,  # 第1盘盘胜者(Set Winner-1st Set); 全场独赢=5001 在 pe=5002 下不存在
    },
    7: {  # 棒球
