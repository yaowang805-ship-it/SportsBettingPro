...
NFL_DATA = {  # V4.3: MGM Grand close odds 2,718 bets (2021-2025), 替代旧SBR 6K
    ...
    3: (0.545, 1.77, 268), 4: (0.459, 1.99, 157), 5: (0.416, 2.19, 209),
    6: (0.412, 2.38, 182), 7: (0.336, 2.57, 149), 8: (0.383, 2.77, 94),
    9: (0.325, 2.99, 83), 10: (0.387, 3.22, 62), 11: (0.190, 3.38, 63),
    12: (0.200, 3.58, 35), 13: (0.271, 3.77, 59), 14: (0.309, 4.04, 55),
    15: (0.200, 4.33, 25), 16: (0.207, 4.62, 58), 17: (0.167, 4.97, 24),
    18: (0.158, 5.33, 19), 20: (0.200, 6.12, 15), 21: (0.062, 6.56, 16),
    22: (0.105, 7.08, 19),
}
